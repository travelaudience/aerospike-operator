...
| backupSpec | The specification of how Aerospike namespace backups made by aerospike-operator should be performed and stored. | <<aerospikebackupspec,AerospikeBackupSpec>> | false
|===
...
The AerospikeBackupSpec type specifies how Aerospike namespace backups made
by aerospike-operator should be performed and stored.

|===
| Field | Description | Scheme | Required
| storage | The specification of how the backup is stored. | <<backupstoragespec,BackupStorageSpec>> | true
|===
...
| storage | The specification of how the backup is retrieved. | <<backupstoragespec,BackupStorageSpec>> | false
|===
